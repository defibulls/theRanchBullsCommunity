    ...
    <header className="relative">
      {show ? (
        ...
        >
          ...
          />
          <div className="grid md:grid-cols-1 grid-cols-1 w-full md:px-20 px-10 md:mt-0 gap-x-10 mt-32 pb-10 space-y-4 md:space-y-0 items-center justify-center place-items-center">
            {dapps.map((dapp, i) => (
              <DApp
                key={i}
                name={dapp.name}
