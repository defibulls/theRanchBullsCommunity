...
const FAQs = (props: Props) => {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-10 transition-all duration-1000 ease-out md:grid-cols-2">
        {faqs.map((faq, i) => (
          <div
            key={i}
            className="group flex h-fit flex-col rounded-md bg-gray-800 px-20 py-8 transition duration-500 ease-in-out"
          >
