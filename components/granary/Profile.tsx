...
const Profile = () => {
    ...
    const [totalmaintenanceFeeBalance, setTotalmaintenanceFeeBalance] =
        useState < number > (0)
    const [MaintenanceFeeStanding, setMaintenanceFeeStanding] =
        useState < number > (0)
    ...
    const getUserData = async () => {
        ...
        setTotalmaintenanceFeeBalance(btcBullOwner.maintenanceFeeBalance / 1000000)
        setMaintenanceFeeStanding(btcBullOwner.maintenanceFeesStanding)
    ...
    //     const _maintenanceFeeBalance = await contract.methods
    //         .getMaintenanceFeeBalanceForAddress()
    //         .call()

    //     setTotalmaintenanceFeeBalance(_maintenanceFeeBalance / 1000000)

    //     const _MaintenanceFeeStanding = await contract.methods
    //         .getMaintenanceFeeStandingForAddress()
    //         .call()

    //     setMaintenanceFeeStanding(_MaintenanceFeeStanding / 1000000)
    // }

    const paytotalMaintenanceFee = async () => {
        if (totalmaintenanceFeeBalance == 0)
        ...
        <div className="flex min-h-screen flex-col bg-black">
            ...
            <div className="mx-10 flex h-fit w-fit flex-col items-center justify-center rounded-xl bg-black bg-opacity-50 p-10">
                <div className="flex w-full items-start space-x-8 p-10 text-base font-semibold">
                    <h1
                        className={`${modal === 'rewards' ? `border-b-2 border-teal-500` : ``
                    ...
                    <h1
                        className={`${modal == 'buddy' ? `border-b-2 border-teal-500` : ``
                            }  cursor-pointer uppercase`}
                    ...
                    <h1
                        className={`${modal === 'maintenance' ? `border-b-2 border-teal-500` : ``
                            } cursor-pointer uppercase`}
